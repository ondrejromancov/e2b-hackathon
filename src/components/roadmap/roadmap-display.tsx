                    ...
                    {nodePositions.length > 1 && (
                      <>
                        ...
                        {nodePositions
                          ...
                          .map((moduleNode, moduleIndex, moduleArray) => {
                            ...
                            if (moduleIndex < moduleArray.length - 1) {
                              ...
                              const lessonsBetween = nodePositions.filter(
                                node =>
                                  node.type === "lesson" &&
                              ...
                              if (lessonsBetween.length > 0) {
                                ...
                                return (
                                  <path
                                    ...
                                    d={`M ${pathPoints[0].x},${pathPoints[0].y} ${pathPoints
                                      .slice(1)
                              ...
                              const lastModuleLessons = nodePositions.filter(
                                node => node.type === "lesson" && node.order > moduleNode.order
                              )
                              ...
                              if (lastModuleLessons.length > 0) {
                                ...
                                return (
                                  <path
                                    ...
                                    d={`M ${moduleNode.x},${moduleNode.y} ${lastModuleLessons
                                      .map(node => `L ${node.x},${node.y}`)
                                      .join(" ")}`}
                                    fill="none"
                                    stroke="rgba(0, 0, 0, 0.6)"
