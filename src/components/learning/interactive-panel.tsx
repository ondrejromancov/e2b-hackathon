...
import { InteractiveExerciseGenerator } from "./interactive-exercise-generator"

// const SAMPLE_APP: InteractiveApp = {
//   commentary:
...
export function InteractivePanel() {
  ...
  const [interactiveApp, setInteractiveApp] = useState<DeepPartial<InteractiveApp>>()
  ...
  const handleStartExercise = async (app: InteractiveApp) => {
  ...
  return (
    <InteractiveExerciseGenerator 
      onExerciseGenerated={setCurrentPreview}
      onStartSampleExercise={handleStartExercise}
    />
  )
}
